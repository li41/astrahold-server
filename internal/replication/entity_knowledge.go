...
// the world until this returns false. Otherwise an observer whose prior EntityDespawn has not yet
// been accepted by the Reliable transport queue could mistake the new incarnation for the old one
// and never receive a fresh EntitySpawn.
