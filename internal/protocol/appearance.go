...
// state. SkinID is a stable Server-owned gameplay identity, never a Client asset path or UUID.
// BasicAttackAffinityBonus is the currently active flat raw physical basic-attack bonus derived from
// the selected skin and authoritative equipped main-hand WeaponType. Clients must present this value
// but must not recompute or use it to decide gameplay outcomes.
