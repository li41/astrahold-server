...
//
// AuthenticationSubject is optional Server-only account provenance from the credential provider.
// It is never sourced from Client gameplay input and is not part of CharacterIdentity.
//
